...
const renderer = ({ days, hours, minutes, seconds }) => {
  ...
  return (
    <span>
      {days} Days, {hours} Hrs, {minutes} Mins, {seconds} Secs left to submit
    </span>
  );
};
...
export default class extends React.PureComponent {
  ...
  translate = t =>
    translate(t, "registration", this.props.query.locale, {
      // "countries": true,
      // "sectors": true,
  ...
  render() {
    ...
    const isValidatingToken =
      this.state.tokenCookie !== undefined && !this.state.hasValidToken;
              ...
              <div className="row">
                <div className="col-full">
                  {!isLoggedIn && (
                    <div>
                      <p className="content">
                        <b>Already have a registration?</b> Enter to the login
                        page
                      </p>
                      <Link route="registrationLogin" params={{ locale }}>
                        <div className="historyBtn">
                          ...
                          <a
                            className="btn btn--stroke btn--primary full-width btn--large"
                ...
                >
                  <div className="col-full">
                    <h3 className="subhead">
                      {isLoggedIn
                        ? this.translate("confirmation.updateTitle")
                        : this.translate("confirmation.title")}
                    </h3>
                  </div>
                </div>
                  ...
                  <div className="block-tab-full">
                    <div className="col-block" style={{ width: "100%" }}>
                      <div className="item-process__text">
                        <p
                          dangerouslySetInnerHTML={{
                            __html: isLoggedIn
                              ? this.translate("confirmation.updateMessage")
                              : this.translate("confirmation.message")
                          }}
                        />
                        <p>
                          <b>{this.translate("confirmation.refTitle")}</b>
                          <br />#{this.state.confirmation.ref}
                        </p>
                        <p>
                          <b>{this.translate("confirmation.teamNameTitle")}</b>
                          <br />
                          {this.state.confirmation.teamName}
                        </p>
                      </div>
                      <div
                      ...
                      >
                        ...
                        >
                          {isLoggedIn
                            ? this.translate("updateAnother")
                            : this.translate("registerAnother")}
                        </button>
                      </div>
                    </div>
                  </div>
                      ...
                      >
                        {({ loading, error, data, refetch, networkStatus }) => {
                          ...
                          if (!_.isEmpty(data)) {
                            ...
                            if (
                              this.state.currentSelectedRecordIndex ===
                              undefined
                            ) {
                              //console.log('data', data);
                              //this.setState({
                            ...
                            return (
                              <RegistrationFormComponent
                                tokenCookie={this.state.tokenCookie}
                                onShowConfirmation={this.onShowConfirmation}
                          ...
                          <div className="row">
                            <div className="col-full">
                              <p style={{ color: "#000000" }}>
                                <b>New registration? </b>Please read this brief
                                carefully, or skip on ahead if you are
                                confident!
                              </p>
                              <div
                                style={{
                              ...
                              >
                                <Collapsible
                                  trigger="‣ Click here to read registration process briefing"
                                    ...
                                    <div className="row">
                                      <div className="col-full">
                                        ...
                                        <div style={{ padding: "0 0 0 5px" }}>
                                          ...
                                          {this.translate("deadline.content")[0]
                                            .key == "" ? (
                                            <div />
                                          ) : (
                                            <ul>
                                    ...
                                    <div className="row">
                                      <div className="col-full">
                                        ...
                                        <div style={{ padding: "0 0 0 5px" }}>
                                          ...
                                          <p className="content">
                                            The Competitions Committee reserves
                                            the right to accept or reject
                                            competitors on a case-by-case basis.
                                          </p>
                                        </div>
                                      </div>
                                    </div>
