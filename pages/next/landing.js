    ...
    return (
      <ThisPageContainerComponent>
        <Head>
          ...
          <meta
            name="description"
            content="International Blockchain Olympiad is a multidisciplinary design and building competition. IBCOL 2019 invites students from around the world to solve real-world challenges through decentralised applications."
          />
        ...
        <section
          ...
          data-image-src="/static/images/bg-international-blockchain-olympiad-(ibcol).jpg"
        ...
        >
          ...
          <div className="home-content">
            <div className="row home-content__main">
              <h1>Will you sit on the sidelines or get in on the game?</h1>
              <br />
              <br />
              ...
              <div className="col-block">
                <a href="https://www.hsbc.com.hk" target="_blank">
                  <img
                    ...
                    src="/static/images/IBCOL-2020-Organiser-HSBC.png"
                  />
                </a>
              </div>
              <div className="col-block">
                <a href="https://www.cb.cityu.edu.hk" target="_blank">
                  <img
                    style={{ "max-height": "450px" }}
                    src="/static/images/IBCOL-2020-Organiser-CityU-CoB.png"
                  />
                </a>
              </div>
              <div className="col-block">
                <a href="https://www.hkbcs.org" target="_blank">
                  <img
                    style={{ "max-height": "450px" }}
                    src="/static/images/IBCOL-2020-Organiser-HKBCS.png"
                  />
                </a>
              </div>
            </div>
        ...
        <section className="s-section target-section" id="about">
          ...
          <div className="row">
            <p>
              ...
              and{" "}
              <a href="/en-hk/ibcol/2019" target="_blank">
                IBCOL 2019
              </a>
            </p>
            <div className="block-1-3 icon">
              <div className="col-block">
                <div className="countries">
                  <i class="material-icons blue">work</i>{" "}
                  <i class="material-icons black">work</i>{" "}
                  <i class="material-icons red">work</i> <br />{" "}
                  <i class="material-icons yellow">business_center</i>{" "}
                  <i class="material-icons green">business_center</i>
                  <div className="countriesName">
                    <h5 style={{ "margin-top": "1.2rem" }}>
                      Business Case Competition
                    </h5>
                    <p>
                      Contestants define their own problem scopes and develop
                      plans to solve it
                    </p>
                  </div>
                </div>
                ...
                <div className="countries">
                  <div
                    dangerouslySetInnerHTML={{
                      __html:
                        "<!-- Academic Conference --> <i class='material-icons blue'>event_seat</i> <i class='material-icons black'>event_seat</i> <i class='material-icons red'>event_seat</i> <br> <i class='material-icons yellow'>airplay</i> <i class='material-icons green'>airplay</i>"
                    }}
                  />
                  <div className="countriesName">
                    <h5 style={{ "margin-top": "1.2rem" }}>
                    ...
                    <p>
                      Contestants are expected to submit a whitepaper proposing
                      their solution
                    </p>
                  </div>
                </div>
              ...
              <div className="col-block">
                <div className="countries">
                  <div
                    dangerouslySetInnerHTML={{
                      __html:
                        "<!-- Technical Hackathon (optional) --> <i class='material-icons blue'>laptop</i> <i class='material-icons black'>developer_mode</i> <i class='material-icons red'>laptop_chromebook</i> <br> <i class='material-icons yellow'>laptop_windows</i> <i class='material-icons green'>laptop_mac</i>"
                    }}
                  />
                  <div className="countriesName">
                    <h5 style={{ "margin-top": "1.2rem" }}>
                      Technical Hackathon (optional)
                    </h5>
                    <p>
                      Contestants may build something to impress investors and
                      employers
                    </p>
                  </div>
                </div>
              ...
              <div className="col-block">
                <div className="countries">
                  <div
                    dangerouslySetInnerHTML={{
                      __html:
                        "<!-- Countless Use Cases --> <i class='material-icons blue'>developer_mode</i> <i class='material-icons yellow'>widgets</i> <i class='material-icons black'>devices</i> <br> <i class='material-icons green'>storage</i> <i class='material-icons red'>dock</i> <i class='material-icons purple'>laptop_mac</i>"
                    }}
                  />
                  <div className="countriesName">
                    <h5 style={{ "margin-top": "1.2rem" }}>
                    ...
                    <p>
                      Blockchain will generate over $24 trillion HKD by 2030
              ...
              <div className="col-block">
                <div className="countries">
                  <div
                    dangerouslySetInnerHTML={{
                      __html:
                        "<!-- Huge Demand for Talent --> <i class='material-icons blue'>face</i> <i class='material-icons yellow'>face</i> <i class='material-icons black'>face</i> <br> <i class='material-icons green'>face</i> <i class='material-icons red'>face</i> <i class='material-icons purple'>face</i>"
                    }}
                  />
                  <div className="countriesName">
                    <h5 style={{ "margin-top": "1.2rem" }}>
                    ...
                    <p>
                      There is a lack of qualified blockchain professionals
                      around the world
                    </p>
                  </div>
                </div>
              ...
              <div className="col-block">
                <div className="countries">
                  <div
                    dangerouslySetInnerHTML={{
                      __html:
                        "<!-- Renewed Interest in Blockchain --> <i class='material-icons blue'>show_chart</i> <i class='material-icons black'>account_balance</i> <i class='material-icons red'>local_hospital</i> <br> <i class='material-icons yellow'>local_shipping</i> <i class='material-icons green'>color_lens</i>"
                    }}
                  />
                  <div className="countriesName">
                    <h5 style={{ "margin-top": "1.2rem" }}>
                    ...
                    <p>
                      While cryptocurrencies waned, business and governments
        ...
        <section className="s-section target-section" id="committees">
          ...
          <div className="row">
            <p>
              IBCOL 2020 is a competition among nominated delegates from around
              the world. If you would like to participate, find out more from
              the organizing committee of your region. If you would like to
              propose a new committee or join one, please{" "}
              <a href="mailto:pmo@ibcol.org?subject=X-BCOL">let us know</a>{" "}
              today!
            </p>
              ...
              <div className="col-block">
                <div className="item-process__text">
                  <p>
                    ...
                    <br />
                    Email:{" "}
                    <a href="mailto:pmo@ibcol.org?subject=IBCOL">
                      pmo@ibcol.org
                    </a>
                  </p>
                </div>
        ...
        >
          <div className="row section-header">
            <div className="col-block">
              ...
              <p>
                Projects are submitted via the organizing committee of your
                region.
              </p>
            </div>
          </div>
          <div className="row">
            ...
            <p style={{ paddingLeft: "15px" }}>
              Create a new committee or join one? Please{" "}
              <a href="mailto:pmo@ibcol.org?subject=X-BCOL">let us know </a>
              today!
            </p>
          </div>
        ...
        <section className="s-section target-section"></section>
      </ThisPageContainerComponent>
    );
  }
}
