              ...
              <div className="col-block">
                <a href={this.translate("section05.link1")} target="_blank">
                  <img
                    ...
                    src={this.translate("section05.icon1")}
                  />
                </a>
              </div>
              <div className="col-block">
                <a href={this.translate("section05.link2")} target="_blank">
                  <img
                    style={{ "max-height": "450px" }}
                    src={this.translate("section05.icon2")}
                  />
                </a>
              </div>
              <div className="col-block">
                <a href={this.translate("section05.link3")} target="_blank">
                  <img
                    style={{ "max-height": "450px" }}
                    src={this.translate("section05.icon3")}
                  />
                </a>
              </div>
            </div>
          ...
          <div className="row">
            <p
              dangerouslySetInnerHTML={{
                __html: this.translate("section01.contentHTML")
              }}
            />
            <div className="block-1-3 icon">
              <div className="col-block">
                <div className="countries">
                  <div
                    dangerouslySetInnerHTML={{
                      __html: this.translate("section01.icon1")
                    }}
                  />
                  <div className="countriesName">
                    <h5 style={{ "margin-top": "1.2rem" }}>
                      {this.translate("section01.heading1")}
                    </h5>
                    <p
                      dangerouslySetInnerHTML={{
                        __html: this.translate("section01.desc1")
                      }}
                    />
                  </div>
                </div>
              ...
              <div className="col-block">
                <div className="countries">
                  <div
                    dangerouslySetInnerHTML={{
                      __html: this.translate("section01.icon2")
                    }}
                  />
                  <div className="countriesName">
                    <h5 style={{ "margin-top": "1.2rem" }}>
                      {this.translate("section01.heading2")}
                    </h5>
                    <p
                      dangerouslySetInnerHTML={{
                        __html: this.translate("section01.desc2")
                      }}
                    />
                  </div>
                </div>
              ...
              <div className="col-block">
                <div className="countries">
                  <div
                    dangerouslySetInnerHTML={{
                      __html: this.translate("section01.icon3")
                    }}
                  />
                  <div className="countriesName">
                    <h5 style={{ "margin-top": "1.2rem" }}>
                      {this.translate("section01.heading3")}
                    </h5>
                    <p
                      dangerouslySetInnerHTML={{
                        __html: this.translate("section01.desc3")
                      }}
                    />
                  </div>
                </div>
            ...
            <div className="block-1-3 icon">
              <div className="col-block">
                <div className="countries">
                  <div
                    dangerouslySetInnerHTML={{
                      __html: this.translate("section02.icon1")
                    }}
                  />
                  <div className="countriesName">
                    <h5 style={{ "margin-top": "1.2rem" }}>
                      {this.translate("section02.heading1")}
                    </h5>
                    <p
                      dangerouslySetInnerHTML={{
                        __html: this.translate("section02.desc1")
                      }}
                    />
                  </div>
                </div>
              ...
              <div className="col-block">
                <div className="countries">
                  <div
                    dangerouslySetInnerHTML={{
                      __html: this.translate("section02.icon2")
                    }}
                  />
                  <div className="countriesName">
                    <h5 style={{ "margin-top": "1.2rem" }}>
                      {this.translate("section02.heading2")}
                    </h5>
                    <p
                      dangerouslySetInnerHTML={{
                        __html: this.translate("section02.desc2")
                      }}
                    />
                  </div>
                </div>
              ...
              <div className="col-block">
                <div className="countries">
                  <div
                    dangerouslySetInnerHTML={{
                      __html: this.translate("section02.icon3")
                    }}
                  />
                  <div className="countriesName">
                    <h5 style={{ "margin-top": "1.2rem" }}>
                      {this.translate("section02.heading3")}
                    </h5>
                    <p
                      dangerouslySetInnerHTML={{
                        __html: this.translate("section02.desc3")
                      }}
                    />
                  </div>
                </div>
          ...
          <div className="row section-header">
            ...
            <div className="row">
              ...
              <div className="historyBtn">
                <a className="btn btn--primary center" href="program">
                  {this.translate("section03.btnText")}{" "}
                </a>
              </div>
            </div>
          </div>
            ...
            <div className="block-1-3 icon">
              <div className="col-block">
                <div className="countries">
                  <div
                    dangerouslySetInnerHTML={{
                      __html: this.translate("section04.icon1")
                    }}
                  />
                  <div className="countriesName">
                    <h5 style={{ "margin-top": "1.2rem" }}>
                      {this.translate("section04.heading1")}
                    </h5>
                    <p
                      dangerouslySetInnerHTML={{
                        __html: this.translate("section04.desc1")
                      }}
                    />
                  </div>
                </div>
              ...
              <div className="col-block">
                <div className="countries">
                  <div
                    dangerouslySetInnerHTML={{
                      __html: this.translate("section04.icon2")
                    }}
                  />
                  <div className="countriesName">
                    <h5 style={{ "margin-top": "1.2rem" }}>
                      {this.translate("section04.heading2")}
                    </h5>
                    <p
                      dangerouslySetInnerHTML={{
                        __html: this.translate("section04.desc2")
                      }}
                    />
                  </div>
                </div>
              ...
              <div className="col-block">
                <div className="countries">
                  <div
                    dangerouslySetInnerHTML={{
                      __html: this.translate("section04.icon3")
                    }}
                  />
                  <div className="countriesName">
                    <h5 style={{ "margin-top": "1.2rem" }}>
                      {this.translate("section04.heading3")}
                    </h5>
                    <p
                      dangerouslySetInnerHTML={{
                        __html: this.translate("section04.desc3")
                      }}
                    />
                  </div>
                </div>
            ...
            <div className="block-1-3 icon">
              <div className="col-block">
                <div className="countries">
                  <div
                    dangerouslySetInnerHTML={{
                      __html: this.translate("section06.icon1")
                    }}
                  />
                  <div className="countriesName">
                    <h5 style={{ "margin-top": "1.2rem" }}>
                      {this.translate("section06.heading1")}
                    </h5>
                    <p
                      dangerouslySetInnerHTML={{
                        __html: this.translate("section06.desc1HTML")
                      }}
                    />
                  </div>
                </div>
              ...
              <div className="col-block">
                <div className="countries">
                  <div
                    dangerouslySetInnerHTML={{
                      __html: this.translate("section06.icon2")
                    }}
                  />
                  <div className="countriesName">
                    <h5 style={{ "margin-top": "1.2rem" }}>
                      {this.translate("section06.heading2")}
                    </h5>
                    <p
                      dangerouslySetInnerHTML={{
                        __html: this.translate("section06.desc2HTML")
                      }}
                    />
                  </div>
                </div>
              ...
              <div className="col-block">
                <div className="countries">
                  <div
                    dangerouslySetInnerHTML={{
                      __html: this.translate("section06.icon3")
                    }}
                  />
                  <div className="countriesName">
                    <h5 style={{ "margin-top": "1.2rem" }}>
                      {this.translate("section06.heading3")}
                    </h5>
                    <p
                      dangerouslySetInnerHTML={{
                        __html: this.translate("section06.desc3HTML")
                      }}
                    />
                  </div>
                </div>
